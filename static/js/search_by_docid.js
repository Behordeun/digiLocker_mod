      ...
      .then(function (docs) {
        ...
        $("#document_table thead").append(
          `<tr><th>Document Name</th><td>${docs[1]}</td></tr>
                ...
                <tr><th>Uploaded By User Name</th><td id = "owner_name">${
                  docs[4] + " " + docs[6]
                }  </td></tr>
                <tr><th>Uploaded By Email Address</th><td id = "owner_email">${
                  docs[5]
                }</td></tr>
                <tr><td><button class = "btn btn-primary sharedoc" doc_id=${
                  docs[0]
                } doc_name=${
                  docs[1]
                }>Raise Request To Access</button></td></tr>`,
        );
      })

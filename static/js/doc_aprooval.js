...
function getPublicKey() {
  ...
  contract.methods
    .getOwnerDocInfoByDocId(doc_id)
    .call()
    .then(function (details) {
      doc_name = details[0];

      contract.methods
        .getEmailIdByUsrAddr(owner_address)
        .call()
        .then(function (own) {
          ...
          contract.methods
            .getDocIndex(doc_id, owner_address)
            .call()
            .then(function (index) {
              docIndex = index;
              ...
              contract.methods
                ...
                .then(function (key) {
                  ...
                  contract.methods
                    .getEmailIdByUsrAddr(requester_address)
                    .call()
                    .then(function (req) {
        ...
        contract
          ...
          .catch(function (error) {
            ...
            swal({
              ...
              title: "Error!",
              text:
                "Error while checking is the document already shared : " +
                error,
              icon: "error",
            });
          });
